...
class ShippingApprovalController extends Controller
{
    ...
    /**
     * Get shipping approval status for all styles in a PO
     */
    public function index(Request $request, $poId)
    {
        ...
        $pivots = PurchaseOrderStyle::where('purchase_order_id', $poId)
            ->with(['style:id,style_number,description', 'suggestedShipOption'])
            ->get();
