...
class DefaultPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'sample.factory_approve', 'category' => 'Samples', 'description' => 'Approve samples as factory'],
            ['name' => 'sample.approve_agency', 'category' => 'Samples', 'description' => 'Approve samples as agency'],
